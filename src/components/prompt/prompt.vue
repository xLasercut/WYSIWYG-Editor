<template>
    <div class="appContainer">
        <div class="headerBar">{{ title }}</div>
        <div class="inputContainer" ref="inputContainer">
            <div class="inputDiv" v-for="input in inputs">
                <span
                    class="inputLabel"
...
<style src="./prompt.scss" lang="scss" scoped></style>
